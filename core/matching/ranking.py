"""
Job relevance ranking — Phase 15.

Combines keyword and semantic matching scores into one overall
relevance score used to rank job results.
"""
...
def calculate_relevance_score(job: Job) -> float:
    ...
    Semantic matching contributes 60%.
